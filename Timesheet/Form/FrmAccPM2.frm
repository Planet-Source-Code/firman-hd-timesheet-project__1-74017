...
Begin VB.Form FrmAccPM2 
   Caption         =   "Verifikasi Timesheet"
   ClientHeight    =   6780
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8385
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VSFlex8Ctl.VSFlexGrid CboFlex 
         ...
         FormatString    =   $"FrmAccPM2.frx":0000
         ScrollTrack     =   0   'False
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin ACTIVESKINLibCtl.Skin Skin2 
      Left            =   8400
      OleObjectBlob   =   "FrmAccPM2.frx":0029
      Top             =   2760
   End
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   0
      OleObjectBlob   =   "FrmAccPM2.frx":025D
      Top             =   0
   End
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid1 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmAccPM2.frx":0491
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid2 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmAccPM2.frx":0570
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
             ...
             Do Until Lrow = .Rows
               If Lrow > 0 Then
                     ...
                     If .TextMatrix(Lrow, 9) <> .TextMatrix(Lrow, 11) Then
                            ...
                            StrSQL = "Update Tbltimesheet Set StatusPM = '" & .TextMatrix(Lrow, 9) & "',last_update='" & Now & "',last_user='" & StrUser & "' Where Tanggal Between '" & Format(DTPicker1, "MM/dd/yyyy") & "' And '" & Format(DTPicker2, "MM/dd/yyyy") & "' And NIP = '" & .TextMatrix(Lrow, 3) & "' And NoProject = '" & cboFlex & "'"
                            PerintahExecute (StrSQL)
...
If Rscek.State = adStateOpen Then Rscek.Close
    ...
    Else
        StrSQL = "select Kode,Nama from project Where nip_pm = '" & StrNIPUser & "' group by kode,Nama order by kode"
    End If
