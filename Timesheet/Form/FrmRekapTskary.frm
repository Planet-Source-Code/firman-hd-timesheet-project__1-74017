...
Begin VB.Form FrmRekapTskary 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VSFlex8Ctl.VSFlexGrid cboFlex 
         ...
         FormatString    =   $"FrmRekapTskary.frx":0000
         ScrollTrack     =   0   'False
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex8Ctl.VSFlexGrid CboKaryawan 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"FrmRekapTskary.frx":0029
         ScrollTrack     =   0   'False
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex8Ctl.VSFlexGrid CboDivisi 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"FrmRekapTskary.frx":0052
         ScrollTrack     =   0   'False
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin ACTIVESKINLibCtl.Skin Skin2 
         Left            =   0
         OleObjectBlob   =   "FrmRekapTskary.frx":007B
         Top             =   0
      End
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   360
      OleObjectBlob   =   "FrmRekapTskary.frx":02AF
      Top             =   0
   End
   Begin VSFlex8Ctl.VSFlexGrid fg 
      ...
      FormatString    =   $"FrmRekapTskary.frx":04E3
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFg 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmRekapTskary.frx":05C2
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid1 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmRekapTskary.frx":06A1
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSJoin 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmRekapTskary.frx":0780
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmRekapTskary"
...
If .Rows > 1 Then
    ...
    Next
        .TextMatrix(1, 1) = "Rekap Timesheet Dari " & Format(DTPicker1, "dd MMM yyyy") & " - " & Format(DTPicker2, "dd MMM yyyy") & "  "
        .SaveGrid "C:\TotalJam.xls", flexFileExcel, False
...
'            StrSQL = StrSQL & " tbltimesheet ON Divisi.KD_DIV = tbltimesheet.kd_divisi INNER JOIN Karyawan ON tbltimesheet.NIP = Karyawan.NIP INNER JOIN Project ON tbltimesheet.ProjectUmum = Project.Kode Where tbltimesheet.NIP = '" & CboKaryawan & "'"
'            If Rscek.State = adStateOpen Then Rscek.Close
'            Rscek.Open StrSQL, CN, adOpenStatic
'
...
'                .TextMatrix(.Rows - 1, 6) = TotalJamPUmum
'                .TextMatrix(.Rows - 1, 7) = "100%"
'                .TextMatrix(.Rows - 1, 9) = "0"
'              Else
'                .TextMatrix(.Rows - 1, 1) = NamaDivisi
'                .TextMatrix(.Rows - 1, 4) = ProjectUmum
'                .TextMatrix(.Rows - 1, 5) = NMProjectUmum
'                .TextMatrix(.Rows - 1, 2) = CboKaryawan
'                If Rscek.State = adStateOpen Then Rscek.Close
'                    Rscek.Open "select * From Karyawan Where NIP = '" & CboKaryawan & "'", CN, adOpenStatic
'                    If Not Rscek.EOF Then .TextMatrix(.Rows - 1, 3) = Rscek!Nama
'                .TextMatrix(.Rows - 1, 6) = TotalJamPUmum
'                .TextMatrix(.Rows - 1, 7) = "100%"
'                .TextMatrix(.Rows - 1, 9) = "0"
'              End If
...
'       StatusSisa = False
'          For Lrow = 1 To .Rows - 2
'             TotalJamBulan = .TextMatrix(Lrow, 11)
...
'                .TextMatrix(.Rows - 1, 7) = Round(.TextMatrix(.Rows - 1, 6) / TotalJamBulan * 100, 2) & "%"
'                .TextMatrix(.Rows - 1, 9) = "0"
'
'                .Rows = .Rows + 1
'          End If
...
'         .TextMatrix(.Rows - 1, 7) = "100%"
          ...
          Next
           If .TextMatrix(.Rows - 1, 6) > 0 Then .TextMatrix(.Rows - 1, 7) = Round(.TextMatrix(.Rows - 1, 6) / .TextMatrix(.Rows - 2, 11) * 100, 2) & "%"
'    End If
End With
...
'            GetSet = True
'            NilaiGaji = .TextMatrix(i, 4)
'            Tingkat = .TextMatrix(i, 1)
'            Exit For
'        Else
'             NilaiGaji = 0
'             Tingkat = 0
