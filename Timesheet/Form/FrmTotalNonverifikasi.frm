...
Begin VB.Form FrmTotalNonverifikasi 
   Caption         =   "Rekap Total Timesheet Non Verifikasi"
   ClientHeight    =   7470
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   13260
   ...
   Begin VSFlex8Ctl.VSFlexGrid fg 
      ...
      FormatString    =   $"FrmTotalNonverifikasi.frx":0000
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSJoin 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmTotalNonverifikasi.frx":00DF
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VSFlex8Ctl.VSFlexGrid cboFlex 
         ...
         FormatString    =   $"FrmTotalNonverifikasi.frx":01BE
         ScrollTrack     =   0   'False
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex8Ctl.VSFlexGrid CboKaryawan 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"FrmTotalNonverifikasi.frx":01E7
         ScrollTrack     =   0   'False
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex8Ctl.VSFlexGrid CboDivisi 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"FrmTotalNonverifikasi.frx":0210
         ScrollTrack     =   0   'False
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   120
      OleObjectBlob   =   "FrmTotalNonverifikasi.frx":0239
      Top             =   0
   End
   Begin VSFlex8Ctl.VSFlexGrid VSFg 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmTotalNonverifikasi.frx":046D
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid1 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmTotalNonverifikasi.frx":054C
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSGaji 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmTotalNonverifikasi.frx":062B
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmTotalNonverifikasi"
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set FrmTotalNonverifikasi = Nothing
End Sub
Sub Showdata()
Dim x As Integer
Dim i, J As Integer
