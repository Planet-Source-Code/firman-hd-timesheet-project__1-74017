...
Begin VB.Form FrmRekapTotal 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VSFlex8Ctl.VSFlexGrid cboFlex 
         ...
         FormatString    =   $"FrmRekapTotal.frx":0000
         ScrollTrack     =   0   'False
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex8Ctl.VSFlexGrid CboKaryawan 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"FrmRekapTotal.frx":0029
         ScrollTrack     =   0   'False
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex8Ctl.VSFlexGrid CboDivisi 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   -1  'True
         FormatString    =   $"FrmRekapTotal.frx":0052
         ScrollTrack     =   0   'False
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin ACTIVESKINLibCtl.Skin Skin2 
         Left            =   0
         OleObjectBlob   =   "FrmRekapTotal.frx":007B
         Top             =   0
      End
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   360
      OleObjectBlob   =   "FrmRekapTotal.frx":02AF
      Top             =   0
   End
   Begin VSFlex8Ctl.VSFlexGrid fg 
      ...
      FormatString    =   $"FrmRekapTotal.frx":04E3
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFg 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmRekapTotal.frx":05C2
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFlexGrid1 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmRekapTotal.frx":06A1
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSJoin 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"FrmRekapTotal.frx":0780
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   -1  'True
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmRekapTotal"
...
Private Sub Form_Load()
    ...
    DTPicker1.Value = DateAdd("M", -2, DTPicker1.Value)
